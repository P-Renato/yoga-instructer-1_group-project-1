                ...
                <h3>Schedule</h3>
                  <nav className="scheduleBox">
                    <section className="leftSection">
                        <nav className="schedule-header">
                            <h4>Weekly</h4> <span>01.01.2025-01-07.2026</span>
                        </nav>
                        <nav>
                            <h5>Mindfulness Yoga</h5>
                            <p>Monday 05.01.2026</p>
                            <p>12:00-13:00</p>
                    ...
                    <section className="rightSection">
                        ...
                        <nav className="addtional-info-section">
                            <h4>Additional Info</h4> <span>09-01.2026</span>
